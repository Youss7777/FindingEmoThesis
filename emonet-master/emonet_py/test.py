...
max_emotion, max_prob, pred, arousal, valence = expl_emo.explanations_emonet(file_path, file_name, show_plot=True)

l_a = LocalAnalysis()
l_a.local_analysis(file_path, file_name, max_emotion=max_emotion, max_prob=max_prob, explanation_method='gradcam', nb_objects=3, show_output=True)